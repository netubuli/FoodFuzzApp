...
public class AlcoholGridViewAdapter extends BaseAdapter {
    Context d;
    ArrayList<Alcohol> drinks;
    Db db;

    public AlcoholGridViewAdapter(Context d, ArrayList<Alcohol> drinks){
        this.d = d;
        this.drinks = drinks;
    }
    @Override
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        if(view==null){
            view = LayoutInflater.from(d).inflate(R.layout.alcohol_layout,null,false);
        }
        TextView name = view.findViewById(R.id.name);
        TextView descr = view.findViewById(R.id.desc);
        TextView cost = view.findViewById(R.id.cost);
        ImageView image = view.findViewById(R.id.image);
        final Alcohol drink = (Alcohol) this.getItem(position);
